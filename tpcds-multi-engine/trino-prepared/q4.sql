...
ORDER BY "t_s_secyear"."customer_id" ASC, "t_s_secyear"."customer_first_name" ASC, "t_s_secyear"."customer_last_name" ASC, "t_s_secyear"."customer_preferred_cust_flag" ASC, "t_s_secyear"."customer_birth_country" ASC, "t_s_secyear"."customer_login" ASC, "t_s_secyear"."customer_email_address" ASC
LIMIT 100
