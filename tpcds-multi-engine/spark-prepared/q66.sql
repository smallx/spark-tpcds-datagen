...
FROM (
       ...
       FROM
         ${database}.web_sales, ${database}.warehouse, ${database}.date_dim, ${database}.time_dim, ${database}.ship_mode
       WHERE
       ...
       (SELECT
         ...
         sum(CASE WHEN d_moy = 12
           THEN cs_net_paid_inc_tax * cs_quantity
             ELSE 0 END) AS dec_net
       FROM
         ${database}.catalog_sales, ${database}.warehouse, ${database}.date_dim, ${database}.time_dim, ${database}.ship_mode
       WHERE
