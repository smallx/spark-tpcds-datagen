...
FROM (
       ...
       FROM
         ...
         FROM
           ${database}.web_sales ws LEFT OUTER JOIN ${database}.web_returns wr
...
FROM (
       ...
       FROM
         ...
         FROM
           ${database}.catalog_sales cs LEFT OUTER JOIN ${database}.catalog_returns cr
...
FROM (
       ...
       FROM
         ...
         FROM
           ${database}.store_sales sts LEFT OUTER JOIN ${database}.store_returns sr
